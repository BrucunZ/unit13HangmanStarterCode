...
var correctGuesses =[];
var wrongGuesses = [];
var images = ["../Hangman-1.png","../Hangman-2.png","../Hangman-3.png","../Hangman-4.png","../Hangman-5.png","../Hangman-6.png"];
...
function prepareGame() {
  secretWord = ['W','E','R','E','B','O', 'R', 'E', 'D',"I","N","C","."];
  correctGuesses = [];
  wrongGuesses = [];
  drawWord();
  drawHangman();
...
// 1. alert "You lost!"
function onLose() {
  alert("You Loose! Try Again Next Time!");
